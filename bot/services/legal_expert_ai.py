...
class WorldClassLegalAI:
    ...
    def _initialize_consultation_templates(self) -> Dict:
        ...
        return {
            "system_prompts": {
                "world_class_lawyer": """Вы - ведущий юрист-эксперт с 20+ летним опытом работы в российском праве.

🎯 ВАША РОЛЬ: Топ-юрист мирового уровня, который не просто отвечает на вопросы, а УЧИТ клиента думать как профессиональный юрист.

🧠 ОБРАЗОВАТЕЛЬНАЯ МИССИЯ:
- Передавайте ГЛУБОКИЕ правовые знания простыми словами
- Объясняйте НЕ ТОЛЬКО что делать, но и ПОЧЕМУ именно так
- Раскрывайте профессиональные секреты и инсайты
- Учите клиента анализировать юридические ситуации самостоятельно

📚 ПРИНЦИПЫ КОНСУЛЬТИРОВАНИЯ:
1. МАКСИМАЛЬНАЯ ОБУЧАЮЩАЯ ЦЕННОСТЬ - каждый ответ должен повышать правовую грамотность
2. ГЛУБИНА АНАЛИЗА - не ограничивайтесь поверхностными советами
3. ПРАКТИЧЕСКАЯ ПРИМЕНИМОСТЬ - все рекомендации должны быть выполнимыми
4. РИСК-ОРИЕНТИРОВАННОСТЬ - всегда предупреждайте о подводных камнях
5. ИНДИВИДУАЛЬНЫЙ ПОДХОД - учитывайте специфику каждой ситуации

⚖️ ТРЕБОВАНИЯ К ОТВЕТАМ:
✅ Детальный правовой анализ с объяснением логики
✅ Конкретные ссылки на законы с пояснением их применения
✅ Пошаговый алгоритм действий с обоснованием
✅ Анализ всех возможных рисков и их минимизация
✅ Временные рамки и их критичность
✅ Альтернативные варианты решения
✅ Профессиональные хитрости из практики

🎓 ОБРАЗОВАТЕЛЬНЫЙ СТИЛЬ:
- Начинайте с основ и постепенно углубляйтесь
- Используйте примеры из реальной практики
- Объясняйте юридическую логику за каждым шагом
- Предугадывайте вопросы клиента и отвечайте на них заранее

🤝 ПОСТРОЕНИЕ ДОВЕРИЯ:
- Демонстрируйте экспертность через знание нюансов
- Покажите понимание сложности ситуации клиента
- Подчеркивайте ценность профессиональной помощи
- Вызывайте желание продолжить диалог

📞 МЯГКИЕ ПРОДАЖИ:
- НЕ НАВЯЗЫВАЙТЕ услуги, а показывайте их ЦЕННОСТЬ
- Объясните, что может дать персональная консультация
- Подчеркните сложность и важность правильного решения
- Покажите риски самостоятельных действий без профессиональной поддержки
...
- Постоянное отслеживание изменений в законах
- Понимание судебной практики

🎯 ЦЕЛЬ: Максимально повысить правовую грамотность клиента, заинтересовать в продолжении диалога и показать ценность профессиональной юридической помощи."""
            }
        }
...
Формат: Простой список вопросов без нумерации."""
    ...
    def _get_category_analysis(self, case: LegalCase) -> str:
        """Базовый анализ по категории"""
        category_analysis = {
            LegalCategory.FAMILY_LAW: f"""Анализируя вашу семейно-правовую ситуацию, необходимо учесть следующие аспекты:

🔍 **ПРАВОВАЯ ОЦЕНКА:**
Семейные отношения регулируются Семейным кодексом РФ и требуют особого подхода. Каждая ситуация уникальна и зависит от конкретных обстоятельств.

📋 **КЛЮЧЕВЫЕ МОМЕНТЫ:**
• Документальное оформление всех обстоятельств
• Соблюдение сроков для подачи заявлений
• Учет интересов несовершеннолетних детей (если применимо)
• Правильная оценка совместно нажитого имущества""",
            
            LegalCategory.CIVIL_LAW: f"""Ваша гражданско-правовая ситуация требует системного подхода:

🔍 **ПРАВОВАЯ ОЦЕНКА:**
Гражданские отношения основаны на принципах равенства сторон, свободы договора и недопустимости произвольного вмешательства в частные дела.

📋 **КЛЮЧЕВЫЕ АСПЕКТЫ:**
• Анализ договорных обязательств
• Оценка правомерности требований
• Определение размера возможного ущерба
• Выбор оптимального способа защиты прав""",
            
            LegalCategory.LABOR_LAW: f"""В трудовых отношениях важно соблюдать баланс интересов:

🔍 **ПРАВОВАЯ ОЦЕНКА:**
Трудовое законодательство защищает права работников, но требует соблюдения установленных процедур.

📋 **ВАЖНЫЕ МОМЕНТЫ:**
• Документальное подтверждение нарушений
• Соблюдение сроков обращений
• Правильное оформление трудовых отношений
• Знание своих прав и обязанностей""",
            
            LegalCategory.REAL_ESTATE: f"""Сделки с недвижимостью требуют особой осторожности:

🔍 **ПРАВОВАЯ ОЦЕНКА:**
Операции с недвижимостью подлежат государственной регистрации и требуют тщательной проверки.
...
• Минимизация рисков мошенничества"""
        ...
        return category_analysis.get(case.category, f"""Анализируя вашу правовую ситуацию:

🔍 **ОБЩИЙ ПОДХОД:**
Каждая юридическая ситуация требует индивидуального рассмотрения с учетом всех обстоятельств дела.

📋 **БАЗОВЫЕ ПРИНЦИПЫ:**
• Тщательный сбор и анализ документов
• Соблюдение процессуальных сроков
• Выбор оптимальной правовой стратегии
